        ...
        <div class="w-full relative flex flex-col items-center space-y-4 sm:items-end">
            ...
            >
                ...
                >
                    ...
                    <div
                        v-if="reference && reference?.clientHeight >= 200"
                        class="bg-gradient-to-r sticky -bottom-1 from-indigo-800 to-indigo-930 h-5"
                    ></div>
                    <div
                        :style="bar ?? undefined"
                        :class="[
                            notification.variant === Variant.LOADING &&
                                'bg-gradient-to-r from-indigo-800 to-indigo-930',
                            notification.variant === Variant.SUCCESS && 'bg-gradient-to-r from-green-500 to-green-900',
                            notification.variant === Variant.ERROR && 'bg-gradient-to-r to-red-900 from-red-500',
                        ]"
