<template>
    <button
        ...
        class="bg-gradient-to-r transition hover:brightness-125 min-w-[125px] inline-flex focus:ring-indigo-600 disabled:opacity-40 disabled:brightness-100 disabled:cursor-not-allowed tracking-tight items-center justify-center px-4 py-2 text-sm font-medium rounded-md focus:outline-none"
        :disabled="loading"
    >
